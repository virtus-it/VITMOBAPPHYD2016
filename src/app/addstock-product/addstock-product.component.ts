...
export class AddstockProductComponent implements OnInit {
  ...
  addStockDetails() {
    let input = [{
      "product": {
        "category": this.Detail.data[0].category, "categoryid": this.Detail.data[0].categoryid, "brandname": this.Detail.data[0].brandname, "producttype": this.Detail.data[0].ptype,
  ...
  addDistributorsStock() {
    let input = [{
      "product": {
        "category": this.distributorStockInput.categoryname, "categoryid": this.distributorStockInput.categoryID, "brandname": this.distributorStockInput.brandname, "producttype": this.distributorStockInput.producttype, "userid": this.Detail.data.userid, "invoicedate": "", "paidamt": this.StockInput.distributorpaidamount,
  ...
  addstockFromDistProducts() {
    let input = [{
      "product": {
        "category": this.Detail.data.data[0].category, "categoryid": this.Detail.data.data[0].categoryid, "brandname": this.Detail.data.data[0].brandname, "producttype": this.Detail.data.data[0].ptype, "paidamt": this.StockInput.distributorpaidamount,
  ...
  addstockValidation() {
    ...
    switch (validate) {
      case '1': {
        if (!this.distributorStockInput.categoryID) {
          this.validateMessage = 'Enter product name';
        }
      }
      case '2': {
        if (!this.StockInput.distributorpaidamount) {
          this.validateMessage = 'Enter paid amount';
        }
      }
      case '3': {
      ...
      case '5': {
        if (this.StockInput.stock && this.StockInput.itemCost && this.distributorStockInput.categoryID) {
